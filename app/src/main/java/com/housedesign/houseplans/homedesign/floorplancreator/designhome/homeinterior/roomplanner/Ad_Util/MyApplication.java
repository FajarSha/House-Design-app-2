 ...
 */
package com.housedesign.houseplans.homedesign.floorplancreator.designhome.homeinterior.roomplanner.Ad_Util;
...
import com.housedesign.houseplans.homedesign.floorplancreator.designhome.homeinterior.roomplanner.MainActivity;
import com.housedesign.houseplans.homedesign.floorplancreator.designhome.homeinterior.roomplanner.R;
import com.housedesign.houseplans.homedesign.floorplancreator.designhome.homeinterior.roomplanner.SplashActivity;
...
public class MyApplication extends Application implements ActivityLifecycleCallbacks, LifecycleObserver {
    ...
    private class AppOpenAdManager {
        ...
        private String AD_UNIT_ID = String.valueOf(R.string.app_open_highid);
        private String High_Unit_ID = String.valueOf(R.string.app_open_highid);
        private String Medium_Unit_ID = String.valueOf(R.string.app_open_mediumid);
        private String Low_Unit_ID = String.valueOf(R.string.app_open_lowid);
     ...
     /*   private void setDialog() {
        ...
        private void loadAd(Context context) {
            ...
            AppOpenAd.load(context, getString(R.string.app_open_mediumid), request, new AppOpenAdLoadCallback() {
                /**
...
//                            startActivity(intent);
        ...
        private void forLowloadAd(Context context) {
            ...
            isLoadingAd = true;
            AdManagerAdRequest request = new AdManagerAdRequest.Builder().build();
            AppOpenAd.load(context, getString(R.string.app_open_lowid), request, new AppOpenAdLoadCallback() {
